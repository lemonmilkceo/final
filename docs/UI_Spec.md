...
### 3.3 계약서 상세/서명 (`/worker/contract/:id`)

**Design Intent**  
사업자 페이지와 동일한 수준의 계약 정보 제공. 양측 서명 완료 시 PDF 다운로드 가능.

**Layout Structure (v1.16 - 사업자 페이지와 동일한 UI)**
...
## 📝 Amendment 3: 폴더 모달 및 헤더 UI (2026년 1월 24일)
...
## 📝 Amendment 6: 급여 형태 선택 UI (2026년 1월 24일)

> **버전**: 1.6  
> **변경 사유**: 시급/월급 선택 및 주휴수당 체크박스 카드형 UI로 개선

### A6.1 Step 3 급여 형태 선택 화면
...
```css
/* 선택되지 않음 */
border-2 border-gray-200 rounded-2xl p-5

/* 선택됨 */
border-2 border-blue-500 bg-blue-50 rounded-2xl p-5

/* 아이콘 (선택되지 않음) */
w-12 h-12 rounded-xl bg-gray-100 text-gray-500

/* 아이콘 (선택됨) */
w-12 h-12 rounded-xl bg-blue-500 text-white
...
/* 설명 텍스트 */
text-[13px] text-gray-500 (선택 안됨)
text-[13px] text-blue-600 (선택됨)
```
...
## 📝 Amendment 7: 근무일 설정 UI (2026년 1월 24일)

> **버전**: 1.7  
> **변경 사유**: 주 N일 / 특정 요일 토글 방식으로 UX 개선

### A7.1 Step 5 근무일 설정 화면
...
```css
/* 선택되지 않음 */
bg-gray-100 text-gray-700 rounded-2xl py-4

/* 선택됨 */
bg-blue-500 text-white rounded-2xl py-4
```
...
```css
/* 레이아웃 */
grid grid-cols-4 gap-2 (1행)
grid grid-cols-3 gap-2 (2행)
...
## 📝 Amendment 8: 휴대폰 번호 매칭 UI (2026년 1월 25일)
...
## 📝 Amendment 9: UX 개선 및 프리미엄 UI (2026년 1월 25일)
...
## 📝 Amendment 10: 대시보드 탭 UI (2026년 1월 25일)
...
flex items-center gap-2 px-5 py-3 overflow-x-auto scrollbar-hide
...
/* 탭 버튼 (활성) */
bg-blue-500 text-white  /* 전체 탭 */
bg-[folder.color] text-white  /* 폴더 탭 */
bg-gray-700 text-white  /* 휴지통 탭 */
...
┌────────────────────────────────────────────────────────────────┐
│  🗑️ 휴지통                                                      │
│  삭제된 계약서는 여기서 복구하거나 영구 삭제할 수 있어요            │
└────────────────────────────────────────────────────────────────┘
```
...
/* 제목 */
text-[15px] font-medium text-gray-800 mb-1
...
## 📝 Amendment 11: 공유 바텀시트 UX 개선 (2026년 1월 25일)

> **버전**: 1.11  
> **변경 사유**: 카카오톡 링크 공유 가이드 강화 및 저장 완료 UI 개선
...
/* 강조 텍스트 (파란색) */
text-blue-600 font-bold text-[16px]
```
...
## 📝 Amendment 12: 민감정보 열람 UI (2026년 1월 25일)

> **버전**: 1.12  
> **변경 사유**: 사업자용 근로자 민감정보 보안 열람 UI 추가
...
## 📝 Amendment 13: 서명 완료 페이지 UI (2026년 1월 25일)

> **버전**: 1.13  
> **변경 사유**: 서명 완료 후 계약서 확인 버튼 추가
...
## 📝 Amendment 14: 사업장 선택 UI (2026년 1월 27일)

> **버전**: 1.14  
> **변경 사유**: 계약서 작성 Step 1에 사업장 선택 기능 추가
...
├─────────────────────────────────────┤
│                                     │
│   어떤 사업장에서 근무하나요?        │  ← text-[26px] font-bold
│                                     │
│   근무할 사업장을 선택해주세요       │  ← text-[15px] text-gray-500
│                                     │
│ ┌─────────────────────────────────┐ │
│ │ 🏢 커피하우스 강남점       ●    │ │  ← 선택된 항목
│ │    서울시 강남구 테헤란로 123   │ │
...
├─────────────────────────────────────┤
│                                     │
│ 사업장 이름                          │  ← text-[15px] font-medium
│ ┌─────────────────────────────────┐ │
│ │ 커피하우스 선릉점                 │ │  ← Input (box variant)
│ └─────────────────────────────────┘ │
│                                     │
│ 사업장 주소                          │
│ ┌─────────────────────────────────┐ │
...
├─────────────────────────────────────┤
│ ┌─────────────────────────────────┐ │
│ │      등록하고 선택하기           │ │  ← btn-primary
│ └─────────────────────────────────┘ │
└─────────────────────────────────────┘
```

### 14.5 모든 계약서 화면 사업장명 표시
...
## Amendment 15: 법적 필수 항목 및 MVP 기능 UI (2026년 1월 27일)
...
┌─────────────────────────────────────┐
│ 사업장 규모      5인 이상            │
│ 연차휴가        근로기준법 제60조에   │  ← 5인 이상만
│                따라 부여             │
│ 가산수당        연장·야간·휴일 근로   │  ← 5인 이상만
│                시 50% 이상 가산      │
└─────────────────────────────────────┘
```
...
- 아이콘: 이메일 (✉️)
- 클릭 시: `mailto:lemonmilkceo@gmail.com`
...
- 아이콘 스타일: 비활성 상태 (gray-400)
- 클릭 동작: 토스트 표시, 페이지 이동 없음
...
## 📝 Amendment 16: 사업장 수정/삭제 UI (2026년 1월 28일)
...
/* 삭제 확인 박스 */
.delete-warning-box {
  @apply bg-red-50 rounded-2xl p-4;
}

/* 삭제 버튼 */
.btn-danger {
  @apply py-4 rounded-2xl font-semibold text-lg;
  @apply bg-red-500 text-white;
  @apply active:bg-red-600 disabled:opacity-50;
}
```
...
> **버전**: 1.17  
> **변경 사유**: AI 노무사 검토 기능 무료화에 따른 UI 변경
...
## 📝 Amendment 18: 업종 선택 UI 확장 (2026년 1월 28일)
...
## 📝 Amendment 19: 퇴사 처리 및 근무이력서 UI (2026년 1월 31일)

> **버전**: 1.18  
> **변경 사유**: 근로자 퇴사일 입력 기능 및 경력 관리 UI 개선
...
### 19.2 퇴사 처리 BottomSheet

```css
/* 퇴사 처리 BottomSheet 스타일 */
.resignation-sheet {
  @apply bg-white rounded-t-3xl px-6 pt-3 pb-8;
}

.resignation-info-box {
  @apply bg-blue-50 rounded-xl p-4 text-sm text-blue-700;
}

.resignation-date-input {
  @apply w-full bg-gray-100 rounded-xl px-4 py-3;
  @apply text-gray-900 border-2 border-transparent;
...
│  퇴사일 선택                         │
│  ┌─────────────────────────────┐    │
│  │ 📅  2026-01-31              │    │  ← input type="date"
│  └─────────────────────────────┘    │
│                                     │
│  ⚠️ 근무 시작일(2025.03.01) 이후,   │
│     오늘 이전 날짜만 선택할 수 있어요 │
│                                     │
│  ┌─────────────────────────────┐    │
│  │      퇴사일 저장              │    │  ← btn-primary
...
```css
.resignation-banner {
  @apply bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4;
}

.resignation-banner-icon {
  @apply text-amber-500 text-xl;
}

.resignation-banner-title {
  @apply font-semibold text-amber-800;
}

.resignation-banner-text {
  @apply text-sm text-amber-700 mt-1;
}
```

```
┌─────────────────────────────────────┐
│ 💡 퇴사일 미입력 안내                │  ← bg-amber-50
│                                     │
│    N개 계약서에 퇴사일이 입력되지    │
│    않았어요.                         │
│                                     │
...
┌─────────────────────────────────────┐
│ ┌─────────────────────────────────┐ │
│ │      📄 근무이력서 발급          │ │  ← btn-primary (bg-blue-500)
│ └─────────────────────────────────┘ │
└─────────────────────────────────────┘
```

### 19.5 근무이력서 미리보기 BottomSheet
...
│  │ NO │ 사업장명       │ 기간         │ 일수 │   │
│  ├──────────────────────────────────────────┤   │
│  │ 1  │ 커피하우스     │ 2025.03.01 ~ │ 337 │   │
│  │    │ 강남점        │ 2026.01.31   │     │   │
│  ├──────────────────────────────────────────┤   │
│  │ 2  │ 이디야커피     │ 2024.06.01 ~ │ 275 │   │
│  │    │ 역삼점        │ 2025.02.28   │     │   │
│  └──────────────────────────────────────────┘   │
│                                                 │
│  총 근무일수: 612일                              │
...
## 📝 Amendment 20: 카카오 알림톡 UI (2026년 2월 4일)

> **버전**: 1.21  
> **변경 사유**: 알림톡 발송 관련 UI/UX 스펙 추가
...
```css
/* 성공 카드 */
.alimtalk-success-card {
  @apply bg-green-50 border border-green-200 rounded-xl p-4;
}

/* 성공 아이콘 */
.alimtalk-success-icon {
  @apply text-green-500 text-2xl mb-2;
}
...
/* 재발송 횟수 배지 */
.alimtalk-count-badge {
  @apply bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full;
}

/* 재전송 버튼 */
.btn-alimtalk-resend {
  @apply w-full py-3 bg-gray-100 text-gray-700 rounded-xl font-medium;
}
```
...
```css
/* 실패/경고 카드 */
.alimtalk-warning-card {
  @apply bg-amber-50 border border-amber-200 rounded-xl p-4;
}

/* 경고 아이콘 */
.alimtalk-warning-icon {
  @apply text-amber-500 text-2xl mb-2;
}
```
...
/* 알림톡 버튼 */
.btn-alimtalk {
  @apply flex-1 py-3 px-4 bg-amber-50 border border-amber-200 
         rounded-xl text-amber-700 font-medium flex flex-col items-center gap-1;
}
...
- completed 상태에서는 "공유" 버튼 숨김 (서명 완료 후 공유 불필요)

### 20.3 근로자 연락처 입력 개선 (Step 4)
...
/* 알림톡 안내 박스 */
.alimtalk-info-box {
  @apply bg-blue-50 border border-blue-200 rounded-xl p-3 text-blue-700 text-sm;
}

/* 안내 아이콘 */
.alimtalk-info-icon {
  @apply text-blue-500 mr-1;
}
```
...
| 요소                   | 위치                   | 이유                        |
| ---------------------- | ---------------------- | --------------------------- |
| 카카오톡 공유 아이콘   | 미리보기 하단 버튼     | 알림톡 자동 발송으로 대체   |
| 카카오톡 공유 버튼     | 공유 바텀시트          | 알림톡 + 링크로 단순화      |

### 20.5 토스트 메시지

| 상황                 | 메시지                                    | variant |
| -------------------- | ----------------------------------------- | ------- |
| 알림톡 발송 성공     | "알림톡이 발송됐어요!"                    | success |
| 알림톡 발송 실패     | "알림톡 발송에 실패했어요"                | error   |
| 재발송 성공          | "알림톡이 다시 발송됐어요! (N/3)"         | success |
| 재발송 제한 도달     | "재발송 횟수를 초과했어요 (3/3)"          | error   |
| 휴대폰 번호 없음     | "근로자 휴대폰 번호가 없어요"             | info    |
| 링크 복사 완료       | "링크가 복사됐어요!"                      | success |
...
## 📝 Amendment 22: 관리자 및 폼 입력 UI 개선 (2026년 2월 10일)

> **버전**: 1.21  
> **변경 사유**: 관리자 페이지 데이터 표시 정확성 및 프로모션 코드 생성 UX 개선

### 22.1 관리자 사용자 목록 크레딧 표시

#### 수정 전

| 컬럼 | 표시 |
|------|------|
| 크레딧 | 첫 번째 `credits` 행의 `amount` (타입 무관) |

#### 수정 후

| 컬럼 | 표시 |
|------|------|
| 크레딧 | `credit_type = 'contract'`인 크레딧만 표시 |
...
│ 이름     │ 연락처        │ 크레딧  │ 역할     │ 상태   │ 상세 │
├────────────────────────────────────────────────────────────────┤
│ 이찬희   │ 010-1234-5678 │ 14      │ employer │ 활성   │ →   │
│ 김사장   │ 010-9876-5432 │ 5       │ employer │ 활성   │ →   │
└────────────────────────────────────────────────────────────────┘
```

### 22.2 프로모션 코드 생성 폼 변경
...
| 항목 | 기존 | 변경 |
|------|------|------|
| 라벨 | "최대 사용 횟수" | "최대 사용 횟수 *" |
| placeholder | "비워두면 무제한" | "1" |
| 기본값 | 빈 문자열 | "1" |
| 안내 문구 | "비워두면 무제한으로 사용 가능" | "이 코드를 사용할 수 있는 최대 횟수입니다" |
| 유효성 검사 | 없음 | `1 이상 필수` |

#### 에러 메시지

```
⚠️ 최대 사용 횟수는 1 이상이어야 합니다
```

### 22.3 결제 버튼 활성화 조건

결제하기 버튼은 다음 조건이 모두 충족될 때만 활성화됩니다:

| 조건 | 설명 |
|------|------|
| 카드사 선택 | `selectedCard !== null` |
| 필수 약관 동의 | `agreements.payment === true` |
| 필수 약관 동의 | `agreements.terms === true` |
...
// 비활성화 상태
┌─────────────────────────────────────┐
│        결제하기                      │  ← bg-gray-200, cursor-not-allowed
└─────────────────────────────────────┘

// 활성화 상태
┌─────────────────────────────────────┐
│        결제하기                      │  ← bg-blue-500, cursor-pointer
└─────────────────────────────────────┘
```
