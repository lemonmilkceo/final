...
const ContractPDF = forwardRef<HTMLDivElement, ContractPDFProps>(
  ({ data }, ref) => {
    // 금액 포맷팅
    ...
    return (
      ...
      >
          ...
          <table style={tableStyle}>
            <tbody>
              ...
              <tr>
                ...
                <td style={valueCellStyle}>{data.workStartTime} ~ {data.workEndTime}</td>
              </tr>
              <tr>
            ...
            <table style={tableStyle}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={valueCellStyle}>연장·야간·휴일 근로 시 통상임금의 50% 이상 가산</td>
                </tr>
              </tbody>
            </table>
          </section>
        ...
        >
          <p>
            본 계약서는 근로기준법에 따라 작성되었으며,
            양 당사자가 서명함으로써 효력이 발생합니다.
          </p>
