...
function CareerCertificatePDF({ data, ref }: CareerCertificatePDFProps) {
  // 날짜 포맷팅
    ...
    >
      ...
      <section style={{ marginBottom: '24px' }}>
        ...
        <table style={{ ...tableStyle, marginTop: '12px' }}>
          ...
          <tbody>
            {data.careers.map((career, index) => (
              <tr key={career.id}>
                <td
                  style={{ ...dataCellStyle, textAlign: 'center', width: '8%' }}
                >
                  {index + 1}
                </td>
        ...
        >
          <div style={{ textAlign: 'center' }}>
            ...
            <p
              style={{ fontSize: '16pt', fontWeight: 'bold', color: '#1E40AF' }}
            >
      ...
      <section style={{ marginTop: '40px', textAlign: 'center' }}>
        <p style={{ fontSize: '12pt', lineHeight: '2', color: '#4B5563' }}>
          위 내용은 싸인해주세요에서 체결한 계약서 정보를 바탕으로
          작성되었습니다.
        </p>
      </section>
      ...
      >
        ...
        <p>공식 증명이 필요하면 해당 사업장에 요청해주세요.</p>
      </section>
      ...
      >
        <p>발급: 싸인해주세요 | 전자근로계약서 플랫폼</p>
        <p style={{ marginTop: '4px' }}>signplease.vercel.app</p>
      </footer>
    </div>
  );
}
