  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-5 py-6 prose prose-sm max-w-none">
        ...
        <h2 className="text-[18px] font-bold text-gray-900 mt-8 mb-4">제1조 (목적)</h2>
        ...
        <h2 className="text-[18px] font-bold text-gray-900 mt-8 mb-4">제2조 (서비스의 정의 및 성격)</h2>
        <ol className="text-[15px] text-gray-700 leading-relaxed list-decimal pl-5 space-y-2">
          <li>본 서비스는 소상공인을 위한 <strong>전자 근로계약서 양식 제공 및 카카오톡 공유 기능</strong>을 제공합니다.</li>
          <li><strong>본 서비스는 개인 개발자가 운영하는 베타(Beta) 서비스입니다.</strong> 따라서 서비스의 안정성, 지속성이 보장되지 않으며, 사전 통지 없이 서비스의 전부 또는 일부가 변경되거나 중단될 수 있습니다.</li>
        ...
        <ol className="text-[15px] text-gray-700 leading-relaxed list-decimal pl-5 space-y-2">
          ...
          <li>이용자는 타인의 개인정보를 무단으로 수집, 이용하거나 타인의 명의를 도용하여서는 안 됩니다.</li>
        ...
        <ol className="text-[15px] text-gray-700 leading-relaxed list-decimal pl-5 space-y-2">
          <li>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>전자 근로계약서 양식 작성 기능</li>
              <li>카카오톡을 통한 계약서 공유 기능</li>
        ...
        <ol className="text-[15px] text-gray-700 leading-relaxed list-decimal pl-5 space-y-2">
          <li>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>서비스용 설비의 보수, 점검, 교체 등 공사가 필요한 경우</li>
              <li>시스템 장애, 서비스 이용의 폭주 등으로 정상적인 서비스 제공이 어려운 경우</li>
